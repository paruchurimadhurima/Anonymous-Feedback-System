...
<h1 align="center">Adminusers Records</h1>
</br>
...
$sel_query="SELECT * FROM `adminusers` WHERE 1";
...
<td ><?php echo '<img src='.$row['photo'].' height="100" width="100" class="img-thumnail">';//'<img src="data:image/jpeg;base64,'.base64_encode($row['photo'] ).'" height="100" width="100" class="img-thumnail" />  ';?></td>
...
<input style="background-color: black; color:white;padding: 10px; border: black; border-radius: 0px 0px 0px 0px;" type="button" value="Print this page" onClick="window.print()">
