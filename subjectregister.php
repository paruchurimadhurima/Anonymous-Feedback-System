...
<li><a href='http://localhost/project/complaints.php?category=<?php echo $other;?>' style="color: black; background-color: white; ">Others</a></li>
    ...
    <form method="post" action="subjectregister.php" enctype="multipart/form-data">
  <?php include('errors.php'); ?>
	  ...
	  <div class="input-group">
  	  <button type="submit" class="btn" name="subjectupload" value="Upload" >Upload</button>
  ...
  <div class="header">
  	<h5>Subject Register</h5>
  </div>
	
  <form method="post" action="subjectregister.php">
  	<?php include('errors.php'); ?>
...
<option value="2">2</option>
  	...
  	<div class="input-group">
  	  <button type="submit" class="btn" name="reg_subject" >Register</button>
