...
<h1 align="center">Infrastructure Records</h1>
</br>
...
$sel_query="SELECT * FROM `infrastructure` WHERE type='$category'";
$result=mysqli_query($db1,$sel_query);
...
<td align="center">
<a href="complaintdelete.php?id=<?php echo $row["id"]; ?>&category=<?php echo $row['type'];?>">Delete</a>
</td>
</tr>
<?php $count++;
}
