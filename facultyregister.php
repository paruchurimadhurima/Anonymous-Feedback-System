...
<li><a href='http://localhost/project/complaints.php?category=<?php echo $other;?>' style="color: black; background-color: white; ">Others</a></li>
    ...
    <form method="post" action="facultyregister.php" enctype="multipart/form-data">
  <?php include('errors.php'); ?>
	  ...
	  <div class="input-group">
  	  <button type="submit" class="btn" name="facultyupload" value="Upload" >Upload</button>
