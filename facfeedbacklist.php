...
<?php
$count=1;
$datab=mysqli_connect('localhost', 'root', '', 'feedback');
$sel_query="SELECT * FROM `faculty` WHERE 1";
$result=mysqli_query($datab,$sel_query);
...
<tbody><tr><td ><?php echo $row["id"];?></td>
...
<a align="center" href="facfeedbackdelete.php?id=<?php echo $row["id"]; ?>">Delete</a><br/>
