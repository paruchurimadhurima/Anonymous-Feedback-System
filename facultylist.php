...
<h1 align="center">Faculty Records</h1>
</br>
...
<th><strong>Faculty Fullname</strong></th>
...
<?php
$count=1;
$sel_query="SELECT * FROM `facultydetails` WHERE 1";
...
<td>
<a href="facultydelete.php?slno=<?php echo $row["slno"]; ?>">Delete</a>
</td>
</tr>
<?php $count++;
}
